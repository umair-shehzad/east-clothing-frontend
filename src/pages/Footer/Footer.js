    ...
    <div className="footerCmp">
      <footer>
        ...
        <div className="footerGetInTouch">
          ...
          <ul>
            <p>
              Any questions? Let us know in store at Coza Store Center 8th
              floor, 379 Hudson St, New York, NY 10018 US or call us on (+1)
              0657964665
            </p>
        ...
        <div className="paragraphFooter">
          <p>Copyright ©2021 All rights reserved | East Clothing</p>
        </div>
      </footer>
    </div>
  );
